...
extern EIF_TYPED_VALUE F976_9613(EIF_REFERENCE);
extern EIF_TYPED_VALUE F976_9614(EIF_REFERENCE);
extern EIF_TYPED_VALUE F976_9615(EIF_REFERENCE);
...
EIF_TYPED_VALUE F976_9613 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F976_9614 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F976_9615 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 975, Current, 0, 0, 13604);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(975, Current, 13604);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(7019, "fractional_second", tr1));
